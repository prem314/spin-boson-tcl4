...
computeN[lambdaVal_,TVal_]:=Module[{gen2, TCL2Final,Ltotalff,map,vec,vec1,allTrace,backflowIntegrals,maxBackflow,tmin,tmax,
dt,tvals,evolved,evolved1,x,y,z,x1,y1,z1,LtotalModified},
(*Parameter setup*)
...
Total[positives]*dt,{i,Length[allTrace]},{j,Length[allTrace[[1]]]},{i1,Length[allTrace]},{j1,Length[allTrace[[1]]]}];
...
(*Parameter ranges*)
lambdaList=Range[0.6,8,0.2]; 
temperatureList=Range[0.6,8,0.2]; 


dataNsimpletcl2=ParallelTable[computeN[\[CapitalLambda],T],{T,temperatureList},{\[CapitalLambda],lambdaList},Method->"CoarsestGrained"]


dataNsimpletcl2r=dataNsimpletcl2[[Reverse[Range[Dimensions[dataNsimpletcl2][[1]]]],All]];


figtcl2=ListDensityPlot[Log10[dataNsimpletcl2 + 10^-8],
...
reversedTemperatureList = Reverse[temperatureList];


MatrixPlot[dataNsimpletcl2r + 10^-6,
  FrameLabel -> {"T", "\[CapitalLambda]"},
  ColorFunction -> "TemperatureMap",
  PlotLegends -> Automatic,FrameTicks -> {
    {Thread[{Range@Length@reversedTemperatureList, reversedTemperatureList}], None},
    {Thread[{Range@Length@lambdaList, lambdaList}], None}
  }
]


(*Save["datasimpletcl2_gamma01_thetapi2_modifiedtcl2_4096.mx",dataNsimpletcl2]*)
